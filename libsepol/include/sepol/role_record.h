#ifndef _SEPOL_ROLE_RECORD_H_
#define _SEPOL_ROLE_RECORD_H_
...
extern int sepol_role_set_name(sepol_handle_t *handle, sepol_role_t *role,
			       const char *name);
...
extern int sepol_role_set_flavor(sepol_handle_t *handle, sepol_role_t *role,
				 uint32_t flavor);
